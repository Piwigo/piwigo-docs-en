...
If you are using a Piwigo that is hosted on your own server, and not on [Piwigo Cloud](https://piwigo.org/get-piwigo#cloud), you can synchronize one of your computer's folders with your gallery.
